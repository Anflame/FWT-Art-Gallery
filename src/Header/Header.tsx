  ...
  return (
    <header className={styles.header}>
      <div className={styles.container}>
        <Links children={<img src={theme === 'dark'? logoImg : logoImgLight} alt="logo" className={styles.logo} />} href={'/'} />
        
        <div className={styles.authAndChangeThemeWrapp}>
          <div className={styles.authWrapp}>
              <Button handleClick={handleClickLogIn} className={'authBtn'} children={'login'}></Button>
              <Button handleClick={handleClickSignUp} className={'authBtn'} children={'signUp'}></Button>
          </div>
          <Button handleClick={toggleTheme} className={'themeBtn'} children={(theme === 'dark') ?
        ...
        <div className={styles.menu}>
          <div className={styles.menuPopUpContent}>
            ...
            <div className={styles.menuThemeWrapp} onClick={toggleTheme}>   
                <Button className={'themeBtn'} children={(theme === 'dark') ? <img src={themeIcon} alt='theme' /> : <img src={themeIconLight} alt='theme' />} />
                <p className={styles.menuThemeMode}>{(theme === 'dark') ? 'light mode' : 'dark mode'}</p>
            </div> 
            
            <Button handleClick={handleClickLogIn} className={'authBtnMobile'} children={'login'}></Button>
            <Button handleClick={handleClickSignUp} className={'authBtnMobile'} children={'signUp'}></Button>
          </div>
        </div>
        }
      </div>
