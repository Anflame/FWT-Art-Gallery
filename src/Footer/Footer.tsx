            ...
            <div className={styles.container}>
                <div className={styles.projectInfoSignature}>
                    <p className={styles.projectInfo}>Проект реализован в рамках стажировки
                        для Frontend-разработчиков от компании <Links href={'https://framework.team'} name={'FrameWork Team'} />
                    </p>
                ...
                <ul className={styles.socNetWorksList}>
                    <li className={styles.socNetWorksListes}>
                        <Links href={'https://facebook.com'} name={ theme === 'dark' ? 
                    ...
                    <li className={styles.socNetWorksListes}>
                        <Links href={'https://vk.com'} name={theme === 'dark' ? 
                    ...
                    <li className={styles.socNetWorksListes}>   
                        <Links href={'https://instagram.com'} name={theme === 'dark' ? 
